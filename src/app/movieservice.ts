...
export class Movieservice {
    ...
    {"title": "Inception", "year": 2010, "director": "Christophor Nolan"},
    {"title": "The Shawshank Redemption", "year": 1994, "director": "Frank Darabont"},
    {"title": "The Dark Knight", "year": 2008, "director": "Christophor Nolan"},
  ...
  public favourites = this._favourites.asReadonly();
    ...
    public removeFavourites(index:number){
    this._favourites.update(favourites =>
      favourites.filter((_, i) => i !== index)
    );
  }

  public addFavourite(fav:string) {
